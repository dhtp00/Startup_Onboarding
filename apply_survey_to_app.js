...
console.log("🚀 Mapping 9 CSV Survey Records to defaultCompanies...");
...
// Push full dataset update to Supabase
async function pushFullDatasetToSupabase(companiesList) {
...
console.log("⚡ Executing dataset injection...");
pushFullDatasetToSupabase([]).then(r => console.log("Supabase response status:", r.status));
