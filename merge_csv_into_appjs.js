...
const surveyRecordsMap = {
  ...
  11: { // 김영준 ((주)로컬웨이브)
    ...
    teamCore: "소상공인 200억 스케일업 경영진과 300억 급 금융 IT 아키텍트가 결합하여, 원천 특허와 AI 교환 엔진으로 설립 6개월 만에 SEED 유치 및 TIPS 추천까지 이끌어낸 압도적 실행력의 팀입니다. 결제 관련 원천 특허 1건 출원 완료 상태입니다.",
...
console.log("✅ Successfully injected 9 survey responses into app.js memory initialization!");
